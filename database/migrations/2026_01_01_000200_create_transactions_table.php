...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->string('initiation_source', 30)->default('listing')->index();
            $table->string('agreement_status', 30)->default('accepted')->index();
            $table->foreignId('initiated_by_customer_id')->nullable()->constrained('customers')->nullOnDelete();
            ...
            $table->string('asset_delivery_method', 40)->nullable()->index();
            ...
            $table->text('seller_delivery_note')->nullable();
            $table->text('buyer_inspection_note')->nullable();
