...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('escrow_boxes', function (Blueprint $table) {
            ...
            $table->string('initiation_source', 30)->default('customer_link')->index();
            ...
            $table->char('party_a_invite_token_hash', 64)->nullable()->unique();
            $table->char('party_b_invite_token_hash', 64)->nullable()->unique();
            $table->timestamp('party_a_invite_expires_at')->nullable()->index();
            $table->timestamp('party_b_invite_expires_at')->nullable()->index();
            $table->timestamp('party_a_invite_accepted_at')->nullable();
            $table->timestamp('party_b_invite_accepted_at')->nullable();
        ...
        Schema::create('escrow_box_agreement_versions', function (Blueprint $table) {
            ...
            $table->json('terms');
            $table->string('changed_by_side', 10)->nullable();
