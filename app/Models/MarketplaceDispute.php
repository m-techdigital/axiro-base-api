...
class MarketplaceDispute extends Model {
    ...
    public function openedBy(): BelongsTo { return $this->belongsTo(Customer::class,'opened_by_customer_id'); }
    public function messages(): HasMany { return $this->hasMany(MarketplaceCaseMessage::class,'case_id'); }
