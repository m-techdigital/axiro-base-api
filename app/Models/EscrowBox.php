...
class EscrowBox extends Model
{
    ...
    protected $fillable = [
        ...
        'created_by_customer_id', 'party_a_customer_id', 'party_b_customer_id', 'status', 'deal_type',
    ...
    protected $casts = [
        'invite_expires_at' => 'datetime', 'invite_claimed_at' => 'datetime', 'agreement_terms' => 'array',
    ...
    public function partyA(): BelongsTo { return $this->belongsTo(Customer::class, 'party_a_customer_id'); }
    public function partyB(): BelongsTo { return $this->belongsTo(Customer::class, 'party_b_customer_id'); }
    public function creator(): BelongsTo { return $this->belongsTo(Customer::class, 'created_by_customer_id'); }
    public function transaction(): BelongsTo { return $this->belongsTo(Transaction::class); }
    public function feeRule(): BelongsTo { return $this->belongsTo(EscrowFeeRule::class, 'fee_rule_id'); }
    public function agreementVersions(): HasMany { return $this->hasMany(EscrowBoxAgreementVersion::class); }
    public function obligations(): HasMany { return $this->hasMany(EscrowBoxPaymentObligation::class); }
    public function handoverSteps(): HasMany { return $this->hasMany(EscrowBoxHandoverStep::class); }
    public function media(): HasMany { return $this->hasMany(EscrowBoxMedia::class); }
    public function events(): HasMany { return $this->hasMany(EscrowBoxEvent::class); }
}
