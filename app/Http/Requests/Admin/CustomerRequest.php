...
class CustomerRequest extends ApiFormRequest {
 public function rules(): array { $customer=$this->route('customer'); return [
 ...
 public function attributes(): array { return ['username'=>'tên đăng nhập','name'=>'tên khách hàng','email'=>'thư điện tử','phone'=>'số điện thoại','password'=>'mật khẩu','status'=>'trạng thái']; }
}
