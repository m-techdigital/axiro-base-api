...
class MarketplaceOperationsReadService
{
    public function __construct(
        private TransactionLifecycleCatalog $lifecycle,
        private OperationalWorkPresenter $workPresenter,
    ) {}
    ...
    public function overview(): array
    {
        ...
        return [
            ...
            'sla' => $this->workPresenter->slaSummary(),
        ];
    }
    ...
    {
        return $this->workPresenter->documentChecklist($transaction);
    }

    public function todayWork(): array
    {
        return $this->workPresenter->todayWork();
    }
}
